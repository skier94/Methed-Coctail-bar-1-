const API_URL = "https://grateful-longhaired-thought.glitch.me/";
...
const createCartItem = (item) => {
  ...
  li.innerHTML = `
  <img src="img/kiwi-and-apple.jpg" alt="${item.title}" class="order__img">
    ...
    <button class="order__item-delete" data-idls="${
      item.idls
...
const init = async () => {
  ...
  const goodsListtElem = document.querySelector(".goods__list");
  ...
  goodsListtElem.append(...cartsCocktail);
